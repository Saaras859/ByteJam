...
<div>
    ...
    <button class="betplayer" onclick="choosebet('p')">PLAYER</button>
    <button class="betbanker" onclick="choosebet('b')">BANKER</button>
    <button class="bettie" onclick="choosebet('t')">TIE</button>
    <h1 class="betprompt">PICK A BET</h1>
</div>
    ...
    function afterbet() {
        ...
        if (ps == 8 || ps == 9 || bs == 8 || bs == 9) {
            ...
            if (ps == bs) {
                ...
                console.log("playerwin 9 8")
            }
            else if (ps == 8 && bs == 9) {
                console.log("banker win 8 9")
            }
            else if (ps == 9 || ps == 8 && bs != 8 && bs != 9) {
                console.log("playerwin aasdf")
            }
            else if (ps == )
    }
    }
