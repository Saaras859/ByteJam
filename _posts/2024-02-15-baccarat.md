...
<script>
    ...
    function afterbet() {
        ...
        if (ps == 8 || ps == 9 || bs == 8 || bs == 9) {
            ...
            console.log("player less than or equal to 5")
            //Player draws a new card
            getplayercard()
            console.log("lastplayercard:", lastplayercard, "bs:", bs);
            ps = calculatePlayerScore()
            ...
            // Check if the banker should draw a third card based on player's third card and banker's current score
                ...
                console.log("Banker draws a new card");
                getBankercard();
                bs = calculateBankerScore();
                ...
                console.log("Banker doesn't draw a new card");
